# Assim, suponha que você possui R$10.000 iniciais,
# consegue aportar R$1.000 por mês e obtém um rendimento de 0,54% ao mês.
...
# No segundo mês, o valor inicial é de R$11.054,00. Ele rende 0,54%, totalizando R$11.113,69.
# Com o novo aporte, R$12.113,69, e assim sucessivamente.
...
# Em uma função, receba, como entrada, um montante financeiro inicial,
# um percentual de rendimento por período, um valor de aporte para
